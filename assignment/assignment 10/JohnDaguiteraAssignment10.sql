...
INSERT INTO `customerorder` VALUES (1,22,23,2,'2021-03-12',12,3.80),(2,22,24,4,'2021-03-12',12,19.96),(3,33,14,6,'2021-03-12',12,26.94),(4,33,20,4,'2021-03-12',12,51.96),(5,11,64,4,'2021-03-12',12,89.96),(6,11,74,10,'2021-03-12',12,109.90),(7,35,1,4,'2021-03-12',12,39.96),(8,15,10,6,'2021-03-12',12,59.94),(9,25,80,3,'2021-03-12',12,44.97),(10,12,9,8,'2021-03-12',12,103.92);
...
INSERT INTO `customerpayment` VALUES (1,1,3.80,'2021-03-24'),(2,2,19.96,'2021-03-24'),(3,3,26.94,'2021-03-24'),(4,4,51.96,'2021-03-24'),(5,5,89.96,'2021-03-24'),(6,6,109.90,'2021-03-24'),(7,7,39.96,'2021-03-24'),(8,8,59.94,'2021-03-24'),(9,9,44.97,'2021-03-24'),(10,10,103.92,'2021-03-24');
/*!40000 ALTER TABLE `customerpayment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `customerpaymnetdetail`
--

DROP TABLE IF EXISTS `customerpaymnetdetail`;
/*!50001 DROP VIEW IF EXISTS `customerpaymnetdetail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `customerpaymnetdetail` AS SELECT 
 1 AS `Customer`,
 1 AS `Customer Order`,
 1 AS `Product`,
 1 AS `Product Total`*/;
...
INSERT INTO `product` VALUES (1,'lamb shank',1,'lamb shank in rosemary and mint sauce',10.0,80,9.99,1),(2,'veal',1,'veal osso buco',15.5,105,11.99,1),(3,'short rib',1,'braveheart angus beef boneless short rib',12.0,40,7.99,1),(4,'flank steak',1,'braveheart angus beef flank steak',2.0,30,16.99,2),(5,'chicken',1,'boneless chicken breasts',8.0,56,21.99,3),(6,'pork chops',1,'bacon-wrapped pork chops',4.0,42,19.99,3),(7,'langoustines',2,'medium wild langoustines',7.0,25,20.99,3),(8,'octopus',2,'cooked small octopus tentacles',3.0,105,23.00,3),(9,'shrimp',2,'red shrimp from argentina XL',12.0,50,12.99,3),(10,'clams',2,'coquina clams',12.0,45,9.99,3),(11,'peas',3,'extra fine french peas',2.0,60,5.99,2),(12,'artichoke',3,'artichoke bottoms',2.0,24,17.69,2),(13,'bean',3,'very find yellow wax beans',2.0,30,6.29,2),(14,'broccoli',3,'broccoli florets',2.0,55,4.49,2),(15,'potatoes',3,'family size smashed red potatoes',32.0,55,12.99,1),(16,'potatoes',3,'family size whipped sweet potatoes',32.0,55,14.49,1),(17,'potatoes',3,'potatoes au gratin',3.0,55,8.49,1),(18,'rice',4,'jasmine rice',2.0,45,9.99,2),(19,'rice',4,'brown, red and wild rice medley',2.0,35,9.99,2),(20,'quinoa',4,'organic quinoa',2.0,26,12.99,2),(21,'lentils',4,'black beluga lentils',2.0,90,9.99,2),(22,'pastry',5,'frangipane king cake',19.0,32,19.99,1),(23,'pastry',5,'chocolate croissant',3.0,90,1.90,1),(24,'dessert',5,'tiramisu classico',3.0,60,4.99,1),(25,'dessert',5,'authentic french creme brulee',5.0,54,5.99,1),(26,'pie',5,'cappuccino pie',3.0,130,36.50,2),(27,'cake',5,'red berry cheesecake',3.0,120,36.50,2),(28,'bread',5,'brioche burger buns',4.0,44,4.80,3),(29,'bread',5,'ciabatta sandwich 6 inch',3.0,28,3.29,3),(30,'dough',5,'mini blinis',16.0,26,4.46,3),(61,'steak',1,'Butcher\'s Cut Filet Mignon',10.0,30,33.74,1),(62,'steak',1,'Butcher\'s Cut Top Sirloin',5.0,50,14.99,1),(63,'steak',1,'T-Bone Steak',18.0,40,33.33,1),(64,'bison',1,'Ground Bison',1.0,80,22.49,2),(65,'turkey',1,'Home-Style Roasted Turkey Breast',1.8,45,21.99,2),(66,'turkey',1,'Turkey Burgers',8.0,30,21.99,3),(67,'ham',1,'Spiral Sliced Ham',9.0,105,89.99,2),(68,'pork',1,'Breaded Pork Tenderloin',4.0,25,19.99,3),(69,'salmon',2,'Lemon Dill Salmon Fillets',6.0,80,8.79,1),(70,'seabass',2,'Chilean Sea Bass',5.0,30,19.99,1),(71,'crab',2,'King Crab Legs',2.0,100,109.99,2),(72,'crab',2,'Gourmet Crab Cakes',4.0,26,34.99,3),(73,'lobster',2,'Cold Water Lobster Tails',5.0,35,22.99,1),(74,'bean',3,'Green Beans',6.5,45,10.99,1),(75,'broccoli',3,'Steakhouse Broccoli and Cauliflower Gratin',22.0,35,12.99,1),(76,'brussels sprouts',3,'Brussels Sprouts with Bacon & Shallots',9.5,35,14.99,1),(77,'corn',3,'Steakhouse Creamed Corn',20.0,40,10.99,1),(78,'mixed',3,'Roasted Vegetable Medley',7.0,50,9.99,1),(79,'asparagus',3,'Asparagus Spears With Hollandaise Sauce',12.0,30,15.99,1),(80,'potatoes',3,'Potatoes au Gratin',8.0,55,14.99,3),(81,'risotto',4,'Pepper Jack Risotto Cakes',8.0,25,19.99,3),(82,'rice',4,'Harvest Rice Pilaf',25.0,45,14.99,1),(83,'bread',5,'Mini Baguettes with Garlic Butter',4.0,35,49.99,3);
...
INSERT INTO `purchaseorder` VALUES (1,1,1,10,'2021-03-12',12,99.90),(2,1,2,15,'2021-03-12',12,179.85),(3,3,8,15,'2021-03-12',12,345.00),(4,7,21,12,'2021-03-12',12,119.88),(5,9,26,20,'2021-03-12',12,730.00),(6,9,27,18,'2021-03-12',12,657.00),(7,2,64,10,'2021-03-12',12,224.90),(8,3,67,15,'2021-03-12',12,1349.85),(9,4,71,14,'2021-03-12',12,1539.86),(10,5,69,10,'2021-03-12',12,87.90);
...
/*!50001 VIEW `customerorderdetail` AS select concat(`c`.`firstName`,' ',`c`.`lastName`) AS `Customer`,`p`.`description` AS `Product`,`co`.`quantity` AS `Quantity`,`co`.`orderDate` AS `Date Ordered`,`os`.`state` AS `Order Status` from (((`customer` `c` join `customerorder` `co`) join `orderstate` `os`) join `product` `p`) where ((`co`.`productId` = `p`.`ID`) and (`co`.`customerId` = `c`.`ID`) and (`co`.`orderStateId` = `os`.`ID`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `customerpaymnetdetail`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `customerpaymnetdetail` AS select concat(`c`.`firstName`,' ',`c`.`lastName`) AS `Customer`,`cp`.`customerOrderId` AS `Customer Order`,`p`.`description` AS `Product`,`co`.`total` AS `Product Total` from (((`product` `p` join `customer` `c`) join `customerorder` `co`) join `customerpayment` `cp`) where ((`cp`.`customerOrderId` = `co`.`ID`) and (`co`.`customerId` = `c`.`ID`) and (`co`.`productId` = `p`.`ID`)) order by `c`.`lastName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `purchaseorderdetail` AS select `s`.`supplierName` AS `Supplier`,`p`.`description` AS `Product`,`po`.`quantity` AS `Quantity`,`po`.`orderDate` AS `Date Ordered`,`os`.`state` AS `Order Status` from (((`supplier` `s` join `product` `p`) join `purchaseorder` `po`) join `orderstate` `os`) where ((`po`.`supplierId` = `s`.`ID`) and (`po`.`productId` = `p`.`ID`) and (`po`.`orderStateId` = `os`.`ID`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `suppliertransactiondetail` AS select `s`.`supplierName` AS `Supplier`,`st`.`purchaseOrderId` AS `Purchase Order`,`p`.`description` AS `Product`,`po`.`total` AS `Product Total` from (((`supplier` `s` join `suppliertransaction` `st`) join `product` `p`) join `purchaseorder` `po`) where ((`st`.`purchaseOrderId` = `po`.`ID`) and (`po`.`supplierId` = `s`.`ID`) and (`po`.`productId` = `p`.`ID`)) order by `s`.`supplierName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-04-26 14:31:12
