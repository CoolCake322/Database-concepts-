/*
	insert into table productSupplier the primary key for each product
	and supplier based on table.column product.id and supplier.id
	
	data provided in format (<product.description>, <supplier.supplierName>)	
*/
insert into(<product.description>, <supplier.supplierName>) values
